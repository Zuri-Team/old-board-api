...
class TrackController extends Controller
{
    ...
    public function create_track(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'track_name' => 'bail|required|string',
            'track_description' => 'required|string',
        ]);
    ...
    public function join_track(Request $request)
    {
        ...
        try {
            ...
            if (!$track) {
                return $this->ERROR('Track does not exist');
            }

            if ($has_joined) {
                return $this->ERROR('You have already joined this track');
            }
    ...
    public function add_user_to_track(Request $request)
    {
        ...
        try {
            ...
            if ($has_joined) {
                return $this->ERROR('User already joined this track');
            }
    ...
    public function remove_user_from_track(Request $request)
    {
        ...
        try {
            ...
            if (!$track) {
                return $this->ERROR('User not associated with selected track');
            }
    ...
    public function get_all_tracks()
{
        ...
        if (!$tracks) {
            return $this->ERROR('No track found');
        }
...
{
        if (!isset($id)) {
            return $this->ERROR('No track specified');
        }
