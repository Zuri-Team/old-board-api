...
Route::delete('intern/delete/{id}', 'InternsController@destroy');
    ...
    Route::group(['prefix' => 'task-grade'], function () {
    Route::post('/task/{id}', 'TaskSubmissionController@grade_task_for_interns');
    ...
    Route::get('/task/{id}/interns', 'TaskSubmissionController@view_all_intern_grades');
    }    
