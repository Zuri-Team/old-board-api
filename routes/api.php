...
Route::delete('intern/delete/{id}', 'InternsController@destroy');
    ...
    Route::post('promote_admins_to_stage_4', 'TaskSubmissionController@promote_admins_to_stage_4'); //promote interns to stage 2
    Route::post('promote', 'TaskSubmissionController@promote_to_stage_4'); //promote interns to stage 2
